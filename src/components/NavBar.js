...
const NavBar = () => {
  ...
  return (
    <header className='w-full px-32 py-8 font-medium item-center justify-between dark:text-light flex relative z-10 lg:px-16 md:px-12 sm:px-8'>
    ...
    <div className='w-full flex justify-between items-center lg:hidden'>
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href="https://github.com/newstar456" target={'_blank'} whileHover={{y:-2}} className='w-6 mx-3' whileTap={{scale:0.9}}>
          <GithubIcon />
        </motion.a>
        <motion.a href="https://www.linkedin.com/in/viktoria-v-5a0634129/" target={'_blank'} whileHover={{y:-2}} className='w-6 mx-3' whileTap={{scale:0.9}}>
          <LinkedInIcon />
        </motion.a>
      ...
      isOpen ? 
        ...
        className='min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
          ...
          <nav className='flex items-center justify-center flex-wrap mt-2'>
            <motion.a href="https://github.com/newstar456" target={'_blank'} whileHover={{y:-2}} className='w-6 mx-3 bg-light dark:bg-dark rounded-full sm:mx-1' whileTap={{scale:0.9}}>
              <GithubIcon />
            </motion.a>
            <motion.a href="https://www.linkedin.com/in/viktoria-v-5a0634129/" target={'_blank'} whileHover={{y:-2}} className='w-6 mx-3 sm:mx-1' whileTap={{scale:0.9}}>
              <LinkedInIcon />
            </motion.a>
            {/* <button onClick={()=>setMode(mode === 'light' ? 'dark' : 'light')} className={`ml-3 flex items-center justify-center rounded-full p-1 ${mode === 'light' ? 'bg-dark text-light' : 'bg-light text-dark'}`}>
              {
